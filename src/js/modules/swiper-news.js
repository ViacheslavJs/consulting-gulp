export const sliderSwiperNews = () => {

try {
  const moduleSliderSwiperNews = document.getElementById('sliderSwiperNews'); 
  console.log(moduleSliderSwiperNews);
  if (moduleSliderSwiperNews !== null) {
...
// set parameters:
const prefixName = 'news'; // имя блока html
...
function showModalImg() {  
  ...
  //modalLayer.classList.remove('news-layer-hidden');   
  onEffect(); 
...
//console.log(collection, 'sliderSwiperNews');
